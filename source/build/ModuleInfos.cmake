...
SET( ${MODULE_VAR_NAME}_INCLUDES
    ...
    ${NIGEL_INCLUDES}					# Nigel dependency
    ${GOOEY_INCLUDES}					# Gooey dependency
    ${GLARE_INCLUDES}					# GLare dependency
	${CMAKE_CURRENT_LIST_DIR}/../inc	# Headers
	${CMAKE_CURRENT_LIST_DIR}/..		# Templates cxx
)
SET( ${MODULE_VAR_NAME}_DEFINITIONS ${QT_DEFINITIONS} )
SET( ${MODULE_VAR_NAME}_QT_RESOURCES_FILE ${${MODULE_VAR_NAME}_ROOT_DIR}/resources/pantin.qrc )
